...
import { AppBar, Box, Button, Container, Grid, IconButton, Paper, Tab, Tabs, Typography, Dialog, DialogTitle, DialogContent, DialogActions, TextField, Avatar } from '@mui/material';
...
const BrandManager = () => {
  ...
  useEffect(() => {
    fetchLocations();
    // Optionally fetch brand name from Firestore
  }, [brandId]);
